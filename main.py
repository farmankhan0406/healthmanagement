...
# #             with open("harry_exer.txt","a") as op:
...
# #         if (c == 1):
# #             value = input("type here\n")
# #             with open("rohan_exer.txt", "a") as op:
# #                 op.write(str([str(gettime())]) + ": " + value + "\n")
# #             print("successfully written")
# #         elif (c == 2):
# #             value = input("type here\n")
...
# #         if (c == 1):
# #             value = input("type here\n")
# #             with open("hammad_exer.txt", "a") as op:
# #                 op.write(str([str(gettime())]) + ": " + value + "\n")
# #             print("successfully written")
# #         elif (c == 2):
# #             value = input("type here\n")
...
# #         c=int(input("enter 1 for excersise and 2 for food"))
# #         if(c==1):
# #             with open("harry_exer.txt") as op:
# #                 for i in op:
# #                     print(i,end="")
# #         elif(c==2):
...
# #         c = int(input("enter 1 for excersise and 2 for food"))
# #         if (c == 1):
# #             with open("rohan_exer.txt") as op:
# #                 for i in op:
# #                     print(i, end="")
# #         elif (c == 2):
# #             with open("rohan_exer.txt") as op:
